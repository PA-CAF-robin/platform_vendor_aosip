...
ifeq ($(AOSIP_BUILDTYPE), CI)
    AOSIP_VERSION := $(AOSIP_BUILD_VERSION)-$(AOSIP_BUILDTYPE)-$(AOSIP_BUILD)-$(shell date -u +%Y%m%d-%H%M)
endif

ifndef AOSIP_VERSION
    AOSIP_VERSION := $(AOSIP_BUILD_VERSION)-Merry-Xmas-$(AOSIP_BUILDTYPE)-$(AOSIP_BUILD)-$(BUILD_DATE)
endif
